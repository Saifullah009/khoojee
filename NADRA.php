...
<div class="container">
    <div class="card" style="width: 18rem;">
        <img src="img/nadralogo2.jpg" class="text-center" width="600px" alt="..." class="img111">
...
// $db = mysqli_connect("localhost", "root", "", "khoojee2");
 if(isset($_POST["submit"])) {
  ...
  $insert = "INSERT INTO `nadra`(`fname`, `lname`, `email`, `contact`, `cnic`, `mark`, `address`, `city`, `country`, `gender`, `upload_img`, `dob`) VALUES ('$firstname','$lastname','$Email','$contact','$cnic','$mark','$address','$city','$country','$gender','$profile_img','$dob')";
