...
<html lang="en">
  ...
  <form method="post" enctype="multipart/form-data">
                 <h1 class="text-center mt-3 text-primary">Upload Recent Image Of Missing Person</h1>
        <div class="conatiner">
              <div class="row" >
           <div class="col-md-12">
              <div class="row">
     ...
     <div class="container">  
         <div class="row">
         <div class="col-md-6">
             <img src="img/jinnahmorgue.jpg"width="500px" height="370px"alt="">
         </div>
          <br>
           <div class="col-md-6">
            <img src="img/civil buil.jpg" width="500px" height="370px"alt="">
          </div>
         </div>
          </div>
          <!----form ---->
       ...
       <input type="text" class="form-control btn btn-success text-white" placeholder="Relation with Dead body"name="contatct">
        ...
        <div class="form-check">
         ...
         <div class="btn-group btn-group-toggle " data-toggle="buttons"name="honorable/honoerless" nmae="honorablehonoerless">
            ...
            <input type="radio" name="Honerable" id="option1" checked> Honerable
              </label>
                <label class="btn btn-success">
                  <input type="radio" name="Honerlsse" id="option2"> Honerlsse
                    </label>
                  <label class="btn btn-success">
                 <input type="radio" name="Dont know" id="option3"> Dont know
             </label>
               </div>
                 <br>
                     <br>
...
// $db = mysqli_connect("localhost", "root", "", "khoojee2");
 if(isset($_POST["submit"])) {
  ...
  $insert = "INSERT INTO `civilhonmorgue`( `firstnnambody`, `lastnambody`, `datekeepingbody`, `timekeepbody`, `dateraleasebody`, `timerelalesbody`, 
  `causeofdeath`, `unsusalsymptom`, `nameguardian`, `relationwithbody`, `cnicguardian`, `cnicbody`, `contatct`, `adress`, `honorablehonoerless`, 
