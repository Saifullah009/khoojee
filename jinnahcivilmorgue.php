...
<!---- imgurl---->
<div class="container">
  <h1>JINNAH/CIVIL MORGUE</h1>
  <div class="row">
    <?php
    $sel = "SELECT * FROM `civilhonmorgue` ORDER BY `id` DESC";
    ...
    ?>
        <div class="col-md-4">
          <div class="card">
              ...
              <p><b> date ralease body</B><?= $row['dateraleasebody'];    ?></p>
              ...
              <p><b> Contatct </B><?= $row['contatct'];    ?></p>
              <p><b> adress </B><?= $row['adress'];    ?></p>
              <p><b> honorable honoerless </B><?= $row['honorablehonoerless'];    ?></p>
