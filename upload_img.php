...
// $db = mysqli_connect("localhost", "root", "", "khoojee2");
 if(isset($_POST["submit"])) {
  ...
  $insert = "INSERT INTO `upload_img`(`firstname`, `lastname`, `email`, `contact`, `cnic`, `mark/abnormality`, `address`, `dob`, `city`, `country`, `gender`, `upload_img`) VALUES ('$firstname','$lastname','$Email','$contact','$cnic','$mark','$address','$dob','$city','$country','$gender','$profile_img')";
