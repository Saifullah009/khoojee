...
<html lang="en">
 ...
 ?>
    ...
    <h1 class="text-center mt-3 text-primary">jdc/ansar burney Missing Person</h1>
    <div class="conatiner">
  <div class="row" >
    <div class="col-md-6">
    <div class="row">
...
<div class="row">
      ...
      <div class="mb-3">
        ...
        <div class="form-check">
            <input class="form-check-input" type="radio" name="gender" id="exampleRadios1" value="option1" >
...
// $db = mysqli_connect("localhost", "root", "", "khoojee2");
 if(isset($_POST["submit"])) {
  ...
  $insert = "INSERT INTO `jdcansarmis`(`firstname`, `lastname`, `email`, `contact`, `cnic`, `mark/abnormality`, `address`, `dob`, `city`, `country`, `gender`, `upload_img`) VALUES ('$firstname','$lastname','$Email','$contact','$cnic','$mark','$address','$dob','$city','$country','$gender','$profile_img')";
