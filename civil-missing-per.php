...
<html lang="en">
 ...
 ?>
    ...
    <h1 class="text-center mt-3 text-primary">jinnah/civil Missing Person</h1>
    <div class="conatiner">
  <div class="row" >
    <div class="col-md-6">
    <div class="row">
...
// $db = mysqli_connect("localhost", "root", "", "khoojee2");
 if(isset($_POST["submit"])) {
  ...
  $insert = "INSERT INTO `civil-missing-per`(`firstname`, `lastname`, `email`, `contact`, `cnic`, `mark/abnormality`, `address`, `dob`, `city`, `country`, `gender`, `upload_img`) VALUES ('$firstname','$lastname','$Email','$contact','$cnic','$mark','$address','$dob','$city','$country','$gender','$profile_img')";
